...
import { handleFormError, handleFormSuccess } from '@/lib/client/laravel/helpers/form.helpers'
import {
    Form,
    FormControl,
    FormField,
    ...
    async function onSubmit(data: RegisterFormData) {
        ...
        try {
            const result = await registerAction({
                ...data,
                type: userType === 'client' ? 'user' : 'agent',
                license_number: userType === 'agent' ? data.license : null,
            })
        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Sign up as a {userType === 'agent' ? 'real estate agent' : 'home seeker'}
                    </CardDescription>
                </CardHeader>
                <CardContent>
