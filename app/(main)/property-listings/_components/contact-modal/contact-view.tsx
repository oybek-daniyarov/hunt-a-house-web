import { Building2, MapPin, Phone, Mail, MessageSquare, ExternalLink, BedSingle, Bath, Ruler, BanknoteIcon, Copy } from "lucide-react"
...
const propertyDetails = [
    ...
    },
    {
        ...
        suffix: (listing: App.Data.Lead.LeadListResponse) => 
            listing.budget_frequency ? ` ${listing.budget_frequency.replace('_', ' ')}` : ''
    }
]
