...
import { ArrowRight, Shield, Zap, Bell, Star, ChartBar } from "lucide-react"
        ...
        <div className="space-y-8">
            <div className="space-y-2">
                ...
                <DialogDescription className="text-base leading-relaxed">
                    Join UAE's premier agent platform for direct access to verified property owners and exclusive listings.
                </DialogDescription>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="text-center">
                    <span className="text-sm text-muted-foreground">
                        Not registered yet?{" "}
                        <Link href="/auth/register/agent" className="text-primary hover:text-primary/90 font-medium transition-colors">
