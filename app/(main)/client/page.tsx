        ...
        steps={[
          {
            ...
            description: "Tell us about your property and what you want to achieve"
          },
          {
            number: 2,
            title: "Get Matched",
            description: "We'll connect you with agents who specialize in your needs"
          },
          {
            number: 3,
            title: "Close the Deal",
            description: "Work with your chosen agent to achieve your property goals"
          }
        ]}
      />
        ...
        testimonials={[
          {
            ...
            quote: "The process was incredibly smooth. I found a great agent who helped me sell my property above market value."
          },
          {
            name: "Michael Chen",
            location: "Renting in Melbourne",
            quote: "Found the perfect tenant for my investment property within weeks. The agent was professional and thorough."
          },
          {
            name: "Emma Wilson",
            location: "Bought in Brisbane",
            quote: "The agent understood exactly what I was looking for and helped me find my dream home."
          }
        ]}
      />
